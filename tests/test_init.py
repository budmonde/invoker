...
class TestInit:
    ...
    def test_init_creates_invoker_file(self, temp_project_dir):
        ...
        assert (
            invoker_file.exists()
        ), "invoker.py should be created after initialization"
    ...
    def test_init_file_contents(self, temp_project_dir):
        ...
        ), "Second line should contain DO NOT EDIT warning"
        ...
        assert (
            "class InvokerScript:" in content
        ), "invoker.py should contain InvokerScript class"
        assert (
            "class InvokerModule:" in content
        ), "invoker.py should contain InvokerModule class"
        assert (
            "def __init__" in content
        ), "invoker.py should contain initialization methods"
        assert (
            'if __name__ == "__main__":' in content
        ), "invoker.py should have main entry point"
