...
"""
        ...
        assert (
            output["string_arg"] == "default_string"
        ), "String argument should have default value"
        assert output["int_arg"] == 42, "Integer argument should have default value"
        assert output["float_arg"] == 3.14, "Float argument should have default value"
        assert output["bool_arg"] is False, "Boolean argument should have default value"
        assert output["list_arg"] == [
            "item1",
            "item2",
            "item3",
...
"""
        ...
        assert output["count"] == 99, "Integer argument should be overridden"
        assert output["rate"] == 0.75, "Float argument should be overridden"
...
"""
        ...
        assert output["items"] == ["x", "y", "z"], "List argument should be overridden"
...
"""
        ...
        assert output["tags"] == ["alpha", "beta", "gamma"], "List should be overridden"
...
"""
        ...
        assert output["items"] == ["new_item"], "Empty list should be overridable"
...
"""
        ...
        assert (
            output["method"] == "custom_method"
        ), "Module string argument should be overridden"
        assert (
            output["iterations"] == 50
        ), "Module integer argument should be overridden"
        assert output["rate"] == 0.9, "Module float argument should be overridden"
...
"""
        ...
        result = subprocess.run(
            ["python", str(script_file), "--transformer.format", "xml"],
            cwd=temp_project_dir,
            capture_output=True,
            text=True,
        )
        ...
        assert (
            output["loader_source"] == "default_source"
        ), "First module should use default value"
        assert (
            output["transformer_format"] == "xml"
...
"""
        ...
        result = subprocess.run(
            ["python", str(script_file), "--filter.columns", "name", "age", "email"],
            cwd=temp_project_dir,
            capture_output=True,
            text=True,
        )
...
"""
        ...
        result = subprocess.run(
            ["python", str(script_file), "--validator.strict", "--validator.verbose"],
            cwd=temp_project_dir,
            capture_output=True,
            text=True,
        )
